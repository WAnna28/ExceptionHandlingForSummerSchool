using ExceptionHandlingForSummerSchoolLib;
using ExceptionHandlingForSummerSchoolRun.Classes;
using ExceptionHandlingForSummerSchoolRun.Enums;
using ExceptionHandlingForSummerSchoolRun.ExtensionMethods;
using System;
using System.Collections.Generic;

namespace ExceptionHandlingForSummerSchoolRun
{
    class Autumn
    {
